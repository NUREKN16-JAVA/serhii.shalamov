...
import ua.nure.kn.shalamov.usermanagement.db.MockDaoFactory;
...
public class MainFrameTest extends JFCTestCase {
    ...
    private static final String TEST_FIRST_NAME = "Elvis";
    private static final String TEST_LAST_NAME = "Preseley";
